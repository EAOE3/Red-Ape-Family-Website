const faq = [
    {
        ...
        "(2) The collectors will have the possibility to reserve the next episode’s NFT before the on-sale date (a). <br/>" +
        ...
        "(8.1) The name (or pseudonym), Twitter handle, and link to the collector’s business (with a description), will be showcased on our website. <br/>" +
        ...
        answer: "No. Everyone with an internet connection will be able to watch the TRAF 🙂 Our goal is to make the Bored Apes even more famous by giving viewing rights to everyone out there, and we would like to have viewers from inside and from outside the crypto/NFT space."
    }, {
