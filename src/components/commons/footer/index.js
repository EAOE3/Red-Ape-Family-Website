        ...
        <footer class="footer has-background-black py-5">
            <div class="container has-text-centered">
                ...
                <h1 className="subtitle has-text-warning is-6 mb-3">
                    <a className="has-text-warning" href="https://opensea.io/TRAF_VAULT" target="_blank">Giveaways' Vault</a>
                    &nbsp;
                    | 
                    &nbsp;
                    <a className="has-text-warning" href=" https://etherscan.io/address/0x38Ef1bF1503eFe695525211f5E2cEa9F7BD01cc3" target="_blank">Royalties Wallet</a>
                </h1>
